<?php
 ...
 class WC_Gateway_Tripay_QRISD extends Tripay_Payment_Gateway
 {
     public $sub_id = 'tripay_qrisd';
    
     public function __construct()
     {
         parent::__construct();
         $this->method_title = 'TriPay - QRIS (DANA)';
         $this->method_description = "Pembayaran melalui Scan QR";
         $this->payment_method = 'QRISD';
     ...
     public function init_form_fields()
     {
         $this->form_fields = array(
            'enabled' => array(
                ...
                'label' => __('Aktifkan QRIS (DANA)', 'wc-tripay'),
                'type' => 'checkbox',
                'description' => '',
                'default' => 'no',
            ),
            'title' => array(
                ...
                'default' => __('QRIS (DANA)', 'wc-tripay'),
            ),
            'enable_icon' => array(
